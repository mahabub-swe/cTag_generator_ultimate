## *cTag_generator_ultimate istallation guidline*
...
3. copy the folder into your **workspace**. see following two images......![drag and drop folder](/Screenshot (1).png "drag and drop folder")![select copy folder option](/Screenshot (1).png "select copy folder option")
